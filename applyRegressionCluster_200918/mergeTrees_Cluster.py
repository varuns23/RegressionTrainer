...
outputFile = ROOT.TFile.Open("perfectIC-lowpt-EB"+"_withRegression.root", "RECREATE")
inputFile1 = ROOT.TFile.Open("/hdfs/store/user/varuns/EgammaRegression/94X/Cluster/"+"perfectIC-lowpt-EB-training.root")
inputFile2 = ROOT.TFile.Open("/hdfs/store/user/varuns/EgammaRegression/94X/output/cluster/"+"perfectIC-lowpt-EB"+"-application.root")
